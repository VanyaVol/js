...
//     arrayAddress.push(JSON.parse(JSON.stringify(user.address)));
//
// }
...
//     address: {city: 'Cairo', country: 'Egypt', street: 'Seashore', houseNumber: 45}
// }];
// let address = users.reduce((previousValue, user) =>{
//     previousValue.push({...user.address})
...
//     p.innerText = `Name: ${user.name}, age: ${user.age}, status: ${user.status}, country: ${user.address.country}, city: ${user.address.city}, street: ${user.address.street}, house number: ${user.address.houseNumber}`
//     div.appendChild(p);
// }
...
//
//     const ageUser = document.createElement('div');
...
//     statusUser.innerText = user.status;
//
//     const addressUser = document.createElement('div');
//     addressUser.innerText = `Address: ${user.address.country}, ${user.address.city}, ${user.address.street}, ${user.address.houseNumber}`;
//
//     userBlock.append(nameUser, ageUser, statusUser, addressUser);
// }
...
//     const userHouseNumber = document.createElement('div');
//     userHouseNumber.innerText = user.address.houseNumber;
//
//     userBlock.append(nameUser, ageUser, statusUser, addressUser);
//     addressUser.append(userCountry,userCity,userStreet,userHouseNumber);
//     addressUser.style.backgroundColor = '#dadada';
// }
...
//     ul.innerText = titleList[i].innerText;
//     content.appendChild(ul);
//
//     for (let j = 0; j < pList.length; j++) {
//         if (i === j){
//         const li = document.createElement('li');
//         li.innerText = pList[i].innerText;
//         ul.appendChild(li);
//         }
//     }
// }
...
//     rulesBlock.classList.add('rules', 'rule' + ruleNum);
