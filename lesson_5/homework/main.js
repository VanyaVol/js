...
// console.log(rectangleS(10, 10));

// - створити функцію яка обчислює та повертає площу кола

// let circleS = (radius) => Math.round(Math.pow((Math.PI * radius),2));
// console.log(circleS(3));

// - створити функцію яка обчислює та повертає площу циліндру

// let cylinderS = (hight, radius) => Math.round(2 * Math.PI * radius * (hight + radius));
...
// let createTagP = (textParagraph) => document.write(`<p>${textParagraph}</p>`);
// createTagP('Hello i am is paragraph');

// - створити функцію яка  створює ul з трьома елементами li. Текст li задати через аргумент всім однаковий

// let createUlLi = (textElementLi) => {
//     document.write(`
//     <ul>
//         <li>${textElementLi}</li>
//         <li>${textElementLi}</li>
...
// let createUlLi = (textElementLi,size) => {
//     document.write(`<ul>`);
