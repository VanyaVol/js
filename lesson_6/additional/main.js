...
// let validator = (emailAdress) => {
//     let posSob = emailAdress.indexOf('@');
//     if (!emailAdress.includes('@')) {
//         console.log('Email адрес не містить собачку')
//     } else if ((emailAdress.indexOf('.', posSob) - posSob) <= 3) {
//         console.log('крапка дуже близько')
//     } else if (emailAdress.slice(0, posSob) < 6) {
//         console.log('email короткий');
//     } else {
//         console.log('Email підходить!')
//     }
// }
//
