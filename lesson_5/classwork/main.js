...
// let randomArray = (emptyArray,sizeArray) => {
...
// let randomArray = (emptyArray,sizeArray, limit = 10) => {
//     for (let i = 0; i < sizeArray; i++) {
